; This library supports writing scripts with command line interfaces.
; The typical AHK script relies on GUI elements like message boxes rather than console output.

; TO DO: Factor some code out into File and Process libraries.
